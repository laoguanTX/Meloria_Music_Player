...
class PlayerCustomStatusBar extends StatefulWidget {
  final Widget child;
  ...
  @override
  State<PlayerCustomStatusBar> createState() => _PlayerCustomStatusBarState();
}

class _PlayerCustomStatusBarState extends State<PlayerCustomStatusBar> {
...
} // Ensures _PlayerCustomStatusBarState class is properly closed.
